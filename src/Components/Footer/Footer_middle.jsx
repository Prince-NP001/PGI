  ...
  return (
    <Box component="div">
      <Grid  container alignItems = "center" justify='center' spacing={15}>
        <Grid ref={dataRef1} item xs={6}>
          <Box className={`${'footer_2'} ${inView1?'animateLeft':''}`} >
        ...
        <Grid ref={imgRef1} item textAlign='right' className={`${'img'} ${inView2?'animateRight':''}`} xs={6}><Box component='img'  src={pic}/></Grid>
      </Grid>
    </Box>
  );
};
